      ...
      <div className="container relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto animate-slide-up" style={{ animationDelay: '0.2s' }}>
            Discover the latest in technology, digital transformation, and innovation through engaging articles, videos, and exclusive 5-minute storytelling sessions from across India.
          </p>
